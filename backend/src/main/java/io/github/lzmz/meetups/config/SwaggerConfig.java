...
public class SwaggerConfig {
    ...
    private ApiKey apiKey() {
        return new ApiKey(JwtUtil.HEADER_AUTHORIZATION_KEY, JwtUtil.HEADER_AUTHORIZATION_KEY, "header");
    }
    ...
    private List<SecurityReference> jwtAuthReference() {
        return Arrays.asList(new SecurityReference(JwtUtil.HEADER_AUTHORIZATION_KEY, new AuthorizationScope[0]));
    }
    ...
    private String getEndPointsWhiteList() {
        ...
        whiteList.append(AuthEndpoint.BASE + AuthEndpoint.SIGN_UP + "|");
        whiteList.append(AuthEndpoint.BASE + AuthEndpoint.SIGN_IN);
